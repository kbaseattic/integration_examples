...
from AuthIntegrationImpl import AuthIntegration
impl_AuthIntegration = AuthIntegration(config)
...
class Application:
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_AuthIntegration.test_noauth, name = 'AuthIntegration.test_noauth',
                             types = [])
        self.method_authentication[ 'AuthIntegration.test_noauth' ] = 'none'
        self.rpc_service.add(impl_AuthIntegration.test_auth_optional, name = 'AuthIntegration.test_auth_optional',
                             types = [])
        self.method_authentication[ 'AuthIntegration.test_auth_optional' ] = 'optional'
        self.rpc_service.add(impl_AuthIntegration.test_auth_required, name = 'AuthIntegration.test_auth_required',
                             types = [])
        self.method_authentication[ 'AuthIntegration.test_auth_required' ] = 'required'
            ...
            try:
                ...
                if auth_req != "none":
                    if token is None and auth_req == 'required':
                        err = ServerError()
                        err.data = "Authentication required for AuthIntegration but no authentication header was passed"
                        raise err
